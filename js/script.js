...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //         // Hidden projects: only show when filter matches their exact category
    //         if (isHidden) {
    //             // For "Light Line" (category = "other-games"), show only when "other-games" is selected
    //             if (filterValue === category) {
    //                 card.style.display = "flex";
    //             } else {
    //                 card.style.display = "none";
    //             }
    //             return; // skip further checks for hidden cards
    //         }

    //         // Normal (non-hidden) projects
    //         if (filterValue === "all") {
    //             card.style.display = "flex";
    //         } else if (category === filterValue) {
    //             card.style.display = "flex";
    ...
    // // On page load, find the button that has class "active" and apply its filter
    // const activeButton = document.querySelector(".filter-btn.active");
    // if (activeButton) {
    //     const initialFilter = activeButton.getAttribute("data-filter");
    //     filterProjects(initialFilter);
    // } else {
    //     // Fallback: show all projects if no active button found
    //     filterProjects("all");
    // }
